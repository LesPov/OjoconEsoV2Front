...
@Component({
  selector: 'app-update-minimal-profile',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './update-minimal-profile.component.html',
  styleUrls: ['./update-minimal-profile.component.css']
})
export class UpdateMinimalProfileComponent implements OnInit {
